...
<div class="panel-body">
  <div class="content-row"> 
    <center>
      <h5 class="content-row-title" style="font-size:25px"><i class="glyphicon glyphicon-list-alt"></i>&nbsp E-Buyad Cash Deposit Report
      <hr>
      </h5>
    </center>
    ...
    <div class="col-md-12">
      ...
      <center>
        ...
        <h4>E-BUYad<br>E-Buyad Cash Deposit Report</h4>
      </center>
      <br>
      <p style="font-size: 18px">&nbsp&nbsp&nbspDate: <?php echo date('Y-m-d')?></p>
      <br>
      <p style="font-size: 18px" id="reporttotal"><b>&nbsp&nbsp&nbsp TOTAL CASH DEPOSITS: <b></p>
          ...
          <div class="col-md-12">
                <div class="table-responsive">
                  <table id="example" class="table table-bordered table-hover">
                    <thead>
                      <tr role="row">
                        <th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Member ID: activate to sort column descending">Date</th>
                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Email Address: activate to sort column ascending">Cash Deposits</th>
                      </tr>
                    </thead>
...
@section('internal-scripts')
  ...
  <script>
    function showDailyReport(date){
       ...
       $.ajax({
            url: '/reports/creditreport/get-daily-data',
            type: 'GET',
            data: {
                repdate: date
            },
            success: function(data){
              ...
              document.getElementById('btnpdf').removeAttribute('disabled');
                ...
                document.getElementById('creditform').action = "{{URL::to('/reports/creditreport/dailyPDF')}}";
                ...
                document.getElementById('reporttotal').innerHTML = "<b>&nbsp&nbsp&nbsp TOTAL CASH DEPOSITS: <b>" + (parseFloat(total).toFixed(2)).toString();
              }else{
                alert('NO DATA WAS RECEIVED');
                document.getElementById('reporttotal').innerHTML = "<b>&nbsp&nbsp&nbsp TOTAL CASH DEPOSITS: <b>";
                var t = $("#example").DataTable();
                t.clear().draw();
              }
            }, 
    ...
    function showWeeklyReport(date){
       ...
       $.ajax({
            url: '/reports/creditreport/get-weekly-data',
            type: 'GET',
            data: {
                repdate: date
            },
          ...
          document.getElementById('btnpdf').removeAttribute('disabled');
                ...
                document.getElementById('creditform').action = "{{URL::to('/reports/creditreport/weeklyPDF')}}";
    ...
    function showQuarterlyReport(mon, yr){
       $.ajax({
            url: '/reports/creditreport/get-quarterly-data',
            type: 'GET',
            data: {
                month: mon,
                year: yr
          ...
          document.getElementById('btnpdf').removeAttribute('disabled');
                ...
                document.getElementById('creditform').action = "{{URL::to('/reports/creditreport/quarterlyPDF')}}"
    ...
    function showYearlyReport(yr){
       $.ajax({
            url: '/reports/creditreport/get-annually-data',
            type: 'GET',
            data: {
                year: yr
            },
          ...
          document.getElementById('btnpdf').removeAttribute('disabled');
                ...
                document.getElementById('creditform').action = "{{URL::to('/reports/creditreport/yearlyPDF')}}"
    ...
    function showCustomReport(date1, date2){
       $.ajax({
            url: '/reports/creditreport/get-custom-data',
            type: 'GET',
            data: {
                dtfir: date1,
                dtnex: date2
          ...
          document.getElementById('btnpdf').removeAttribute('disabled');
                document.getElementById('customdate1').value = date;
                document.getElementById('customdate2').value = date2;
                document.getElementById('creditform').action = "{{URL::to('/reports/creditreport/customPDF')}}"
