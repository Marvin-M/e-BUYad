...
@section('content')
  <div class="panel-body">
    ...
    <center><h5 class="content-row-title" style="font-size:25px"><i class="glyphicon glyphicon-credit-card"></i>&nbsp Change Pin Code
      <hr>
      </h5></center>
      ...
      <div class = "panel pane-default">
                    ...
                    <table id="example" class="table table-bordered table-hover">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Option: activate to sort column ascending" style="width: 147px;">Change Pin</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                          ...
                          foreach($resultMembers as $data){
                              ...
                              echo '
                                  <td align="center">
                                          <button type="button" class="btn btn-warning btn-block" href="#mem_form"
        ...
        <div id="updatecard" class="modal fade" role="dialog">
          <div class="modal-dialog">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                ...
                <form  class="form-horizontal" role="form" method="post" action="{{URL::to('/transaction/change-pin/update')}}">
                  <div class="modal-body">
                    <div class="col-md-offset-2 col-md-8">
                      ...
                      <div class="form-group">
                        <label class="col-md-6 control-label">OLD PINCODE:</label>
                        
                        <div class="col-md-6">
                          <input type="password" class="form-control" id="oldpin" name="oldpin" onkeypress="return isNumber(event)" maxlength="4" required>
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-md-6 control-label">EW PINCODE:</label>
                      ...
                      <div class="form-group">
                        <label class="col-md-6 control-label">NEW PINCODE AGAIN:</label>
                        <div class="col-md-6">
                          <input type="password" class="form-control" id="pint" name="pint" onkeypress="return isNumber(event)" required maxlength="4">
                        </div>
                      </div>
                    </div>
                  </div><br>
                  ...
                  <div class="modal-footer">
                    <button id="btnsubmit" type="submit" class="col-md-offset-10 col-md-2 btn btn-warning" disabled="">UPDATE</button>
                  </div>
                </form>
              </div>
            </div>
...
@section('internal-scripts')
  <script>
    $("#oldpin").blur(function(){
      if(document.getElementById('oldpin').value == document.getElementById('pin').value && document.getElementById('oldpin').value.length > 0){
