...
<div class="container" style="background-color:rgba(81, 85, 93, 0.67); padding-bottom:1%">
    <form class="form-signin" role="form" method="post" action="{{URL::to('/verify-login')}}">
        <center style="padding-bottom:10%;">
            ...
            @else
            <p style="font-size:1.5em; color:#fff">No Branch Selected</p>
            @endif
        </center>
    
        @if(Session::get('loginmess') != null)
        <div class="alert alert-danger">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <strong>LOGIN FAILED!</strong> {{Session::get('loginmess')}}
        </div>
        @endif
